    ...
    <div className="flex flex-col justify-center gap-10">
      ...
      <div className="font-poppins z-10 text-justify lg:text-center">
        <p>
          ...
          <span className="text-blue-600">Universidad de Sonora</span>, we are a
          group of students passionate about{" "}
          <span className="text-blue-600">software development</span>. Here, we
          combine our knowledge, creativity, and teamwork to build projects that
          solve real problems. Whether it's developing apps, designing systems,
          or experimenting with new technologies, CSI{" "}
