  ...
  return (
    <div className="w-full h-auto mx-auto flex flex-col items-center">
      ...
      <div className="pt-70   flex flex-row gap-4 ">
        <div
          className="absolute top-63 left-55 w-65 h-65 rounded-full
        ...
        <div className="absolute top-50 left-117">
          <h2 className="font-[Preahvihear] text-[20px]">
            Hello! I Am <span className="text-[#7127BA]">Andres Antelo</span>
          </h2>
        </div>
        <div className="w-max flex flex-col">
          <span className="font-[Preahvihear] text-[20px] underline">
            A front end programmer who
          </span>
          <div className="flex w-160">
            <h1 className="text-[50px] font-[Preahvihear]">
              With great power comes great{" "}
              <span className="text-[#7127BA]">responsibility</span>...
            </h1>
          </div>
          <span className="font-[Preahvihear] text-[20px]">
            I really like Spiderman
          </span>
        </div>
      </div>
      <div className="flex pt-30 flex-col">
        <span className="font-[Preahvihear] text-[50px]">
          I'm a Software Engineer.|
        </span>
        <h2 className="font-[Preahvihear] text-[20px]">
          I am currently looking for a{" "}
          <span className="text-[#7127BA]">job</span>
        </h2>
        <p className="font-[Preahvihear] text-[22px] pt-20 w-250">
      ...
      <div className="pt-20 w-[895px] text-center">
        <h2 className="font-[Preahvihear] text-[24px]">
          I'm currently looking to join a{" "}
          <span className="text-[#7127BA]">cross-functional</span> team that
        ...
        <div className="flex flex-col justify-center gap-2 p-5 select-none">
          ...
          <div className="flex flex-row items-center justify-center gap-2">
            <div className="w-[44px] h-[44px] bg-[#251c31] rounded-full flex items-center justify-center ">
              <img
                src="./public/tools/typescript.svg"
