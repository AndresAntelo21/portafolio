...
export const ExpandableCard: React.FC<Props> = ({ cards }) => {
            ...
            >
              ...
              <div className="">
                ...
                <motion.a
                  href={active.ctaLink}
                  target="_blank"
                  className="inline-block mt-4 py-2 text-sm rounded-full font-bold bg-green-500 text-white"
                >
                  {active.ctaText}
                </motion.a>
          ...
          >
            <div className="flex gap-4 flex-col md:flex-row">
              ...
              <div>
                ...
                <motion.p className="text-neutral-600 dark:text-neutral-400 text-center md:text-left">
                  {card.description}
                </motion.p>
              </div>
            </div>
            <motion.button className="px-4 py-2 text-sm rounded-full font-bold bg-gray-100 hover:bg-green-500 hover:text-white text-black mt-4 md:mt-0">
              {card.ctaText}
            </motion.button>
          </motion.div>
        ))}
