  ...
  if (loading) {
    return (
      ...
      >
        ...
        <div className="relative h-50 w-full overflow-hidden rounded-2xl bg-blue-950 lg:h-75 lg:w-[60%]"></div>
        <div
        ...
        >
          ...
          >
            <div className="flex h-6 w-40 items-center gap-4 rounded-xl bg-blue-950 lg:hidden"></div>
            <div
              className={`flex h-6 w-30 flex-row-reverse gap-4 rounded-xl bg-blue-950 text-2xl text-gray-300 lg:h-9 lg:text-3xl`}
            ></div>
          </div>
          <div
          ...
          >
            <div className="hidden lg:block">
              <div className="flex h-7 w-28 items-center gap-4 rounded-xl bg-blue-950 text-sm"></div>
            </div>
            <div className="font-poppins text-medium h-8 w-60 rounded-2xl bg-blue-950 text-2xl lg:text-3xl"></div>
            <div className="lg:bg-secondary h-25 w-full rounded-md bg-blue-950 p-2 lg:mt-5 lg:h-40 lg:w-2/3 lg:rounded-xl lg:p-4"></div>
          </div>
        </div>
      </Skeleton>
    );
